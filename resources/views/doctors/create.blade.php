        ...
        <form method="POST" action="{{ route('doctors.store') }}">
            ...
            <div class="mt-4">
                ...
                <select id="gender" name="gender" class="mt-1 block w-full rounded-md border border-gray-300 bg-white py-2 px-3 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                        <option class="capitalized" value="male">Male</option>
                        <option class="capitalized" value="female">Female</option>
                        <option class="capitalized" value="other">Other</option>
                </select>
            </div>
            ...
            <div class="mt-4">
                ...
                <select id="speciality" name="speciality"
                    ...
                    @foreach ($specialities as $item)
                        <option class="capitalized" value="{{ $item->id }}">{{ $item->name }}</option>
                    @endforeach
                </select>
            </div>
                ...
                <fieldset>
                    ...
                    <div class="mt-4 space-y-4 grid grid-cols-4">
                        ...
                        <div class="flex items-center">
                            <input id="push-{{$item->id}}" value="{{$item->id}}" name="slot_id" type="radio" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-500">
